            ...
            <div class="col-lg-6">
                <div class="footer-left">
                    <div class="inner">
                        ...
                        <a class="btn btn-style2" href="contact.html"> <span>Get the offer</span> </a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                            ...
                            <div class="footer-widget">
                                <div class="footer-widget widget_nav_menu">
                                    ...
                                    <div class="menu-quick-link-container">
                                        <ul class="menu">
                                            <li class="menu-item-footer"><a href="gdpr.html">GDPR</a></li>
                                            <li class="menu-item-footer"><a href="terms-conditions.html">Terms and conditions</a></li>
                                            <li class="menu-item-footer"><a href="privacy-policy.html">Privacy Policy</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
